...
public class ScooterMainPageFAQTest {
    ...
    // Параметры теста: индекс вопроса, ожидаемый ответ
    private final int questionIndex;
    private final String expectedAnswer;

    public ScooterMainPageFAQTest(int questionIndex, String expectedAnswer) {
    ...
    public void checkDropDownList() throws InterruptedException {
        ...
        mainPage.scrollToLastQuestion();
        mainPage.clickQuestionByIndex(questionIndex);
        String answerSelector = mainPage.getAnswerSelectorByIndex(questionIndex);
